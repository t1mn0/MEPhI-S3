    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            if result:
                ...
                if type == 'TEST_HASHTABLE':
                    test_hashtable_data.append((number, time))
                elif type == 'TEST_UNORDEREDMAP':
...
def plot_results(test_hashtable_data, test_unorderedtable_data):
    ...
    ax.plot(hashtable_x, hashtable_y, label='TEST_HASHTABLE')
    ax.plot(unorderedtable_x, unorderedtable_y, label='TEST_UNORDEREDMAP')
