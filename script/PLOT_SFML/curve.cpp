...
Curve::Curve() : 
    color_(sf::Color::White), size_(sf::Vector2f(100, 100)), fill_(true), thickness_(3), limit_(100) { }

Curve::Curve(const Vector2f &size, const sf::Color& color) : 
    color_(color), size_(size), fill_(true), thickness_(3), limit_(100) { setColor(color); }
