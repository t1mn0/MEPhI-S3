...
public:
    ...
    virtual sequence::Sequence<T>& operator()(sequence::Sequence<T>& sequence, size_t gap_coef, CmpFunction = CmpFunction(default_comparator<T>)) const;
    virtual sequence::Sequence<T>& operator()(sequence::Sequence<T>& sequence, CmpFunction = CmpFunction(default_comparator<T>)) const noexcept;
};
...
public:
    using CmpFunction = Function<int(const T&, const T&)>;
    virtual sequence::Sequence<T>& operator()(sequence::Sequence<T>& sequence, CmpFunction = CmpFunction(default_comparator<T>)) const noexcept override;
...
public:
    using CmpFunction = Function<int(const T&, const T&)>;
    virtual sequence::Sequence<T>& operator()(sequence::Sequence<T>& sequence, CmpFunction cmp = CmpFunction(default_comparator<T>)) const noexcept override;
