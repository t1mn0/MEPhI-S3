...
TEST(LoadTestSUniquePtr, Сreation1000){
    ...
    std::cout << "- - - - - - - - - - - - - - - - - - - - " << std::endl;
    std::cout << "Total time of creation 1000 string* : " << timer_for_rawptr << " nanoseconds" << std::endl;
    std::cout << "Total time of creation 1000 uniqueptr<string> : " << timer_for_uniqueptr << " nanoseconds" << std::endl;
    std::cout << "- - - - - - - - - - - - - - - - - - - - " << std::endl;
}