...
TEST(SharedPtrTest, DefaultConstructor) {
  tmn_smart_ptr::SharedPtr<int> ptr;
...
TEST(SharedPtrTest, ConstructorAndCopy) {
  ...
  tmn_smart_ptr::SharedPtr<int> ptr_2(ptr_1);
  tmn_smart_ptr::SharedPtr<int> ptr_3(ptr_2);
  tmn_smart_ptr::SharedPtr<int> ptr_4(ptr_3);
  tmn_smart_ptr::SharedPtr<int> ptr_5(ptr_4);
...
TEST(SharedPtrTest, Reset) {
  ...
  tmn_smart_ptr::SharedPtr<int> ptr_2(ptr_1);
  tmn_smart_ptr::SharedPtr<int> ptr_3(ptr_1);
...
TEST(SharedPtrTest, UseCount) {
  int* raw_ptr = new int(10);
  tmn_smart_ptr::SharedPtr<int> ptr1(raw_ptr);
  tmn_smart_ptr::SharedPtr<int> ptr2(ptr1);
  tmn_smart_ptr::SharedPtr<int> ptr3(ptr2);
  tmn_smart_ptr::SharedPtr<int> ptr4(ptr2);
