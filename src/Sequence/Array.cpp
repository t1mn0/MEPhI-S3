...
template <typename T, std::size_t N>
typename tmn_iterator::reverse_iterator<typename Array<T, N>::iterator> Array<T, N>::rbegin() noexcept {
    iterator iter(array + N);
    return tmn_iterator::reverse_iterator<iterator>(iter);
}

template <typename T, std::size_t N>
typename tmn_iterator::reverse_iterator<typename Array<T, N>::iterator> Array<T, N>::rend() noexcept {
    iterator iter(array);
    return tmn_iterator::reverse_iterator<iterator>(iter);
}
