...
public:
    ...
    sequence::Sequence<int>& operator()(sequence::Sequence<int>& sequence, CmpFunction& cmp) const noexcept override;
    sequence::Sequence<int>& operator()(sequence::Sequence<int>& sequence) const noexcept override;
...
public:
    ...
    sequence::Sequence<int>& operator()(sequence::Sequence<int>& sequence, CmpFunction&) const noexcept override;
    sequence::Sequence<int>& operator()(sequence::Sequence<int>& sequence) const noexcept override;
};
